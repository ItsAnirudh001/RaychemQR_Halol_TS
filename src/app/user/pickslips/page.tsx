...
export default function PickslipsScreen() {
  ...
  const [pickslips, setPickslips] = useState<Pickslip[] | []>(pickslipsData);
  ...
  return (
    <>
      ...
      <UserAuthHeader {...headerProps}>
        <>
          <FaCube color="blue" className="text-2xl" />
          <h1 className="font-semibold text-sm">Pickslips</h1>
        </>
      </UserAuthHeader>
      ...
      <div className="flex flex-col p-5 gap-5">
        ...
        {searchedData().map((data) => (
          <div
            key={data.oa_no}
            className="flex flex-col bg-white w-full rounded-3xl border-2 border-gray-200 overflow-hidden"
          >
            <div
            ...
            <div className="flex flex-col p-4 gap-4">
              <div className="flex items-center justify-between w-full">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex bg-[linear-gradient(90deg,rgba(43,127,255,1)_10%,rgba(79,57,246,1))] rounded-md p-2 items-center">
                    <FaCube color="white" className="text-sm" />
                  </div>
                  ...
                  <div className="flex flex-col font-medium">
                    ...
                    <textarea
                      disabled
                      className="text-sm w-[24vw] field-sizing-content"
                      value={data.oa_no}
                    />
                  </div>
                </div>
                ...
                {/* scanned */}
                <div className="flex flex-col bg-[rgba(242,247,252,1)] place-items-center p-2 font-medium text-xs rounded-2xl gap-2">
              ...
              {data.status === "created" && (
                <button
                  className="mobile-btn-main py-2.5! font-medium! text-sm!"
              ...
              {data.status === "completed" && (
                <div className="flex w-full justify-between gap-6">
                  ...
                  <button className="mobile-btn-main py-2.5! font-medium! text-sm! text-[rgba(64,108,175,1)]! border border-[rgba(64,108,175,1)] bg-transparent! w-full rounded-xl">
                    Download
                  </button>
                </div>
              )}
